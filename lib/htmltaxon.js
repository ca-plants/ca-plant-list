...
/**
 * @callback FnUrlFactoryWithConfig
 * @param {import("./types.js").Taxon} taxon
 * @param {import("./types.js").Config} config
 * @returns {URL|undefined}
 *
 * @callback FnUrlFactory
 * @param {import("./types.js").Taxon} taxon
 * @returns {URL|undefined}
 */
...
/** @type {Object<string,{label:string,href:FnUrlFactoryWithConfig}>} */
const OBSLINKS = {
    calflora: {
        label: "Calflora",
        href: (taxon, config) =>
...
/** @type {Object<string,{label:string,href:FnUrlFactory}>} */
const REFLINKS = {
    calflora: {
        label: "Calflora",
...
class HTMLTaxon {
     ...
     * @returns {string}
     */
    static getFooterHTML(taxon, dataDir) {
